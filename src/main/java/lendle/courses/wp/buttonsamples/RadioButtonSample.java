    ...
    public static void main(String[] args) throws Exception {
        ...
        ActionListener listener=new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                JOptionPane.showMessageDialog(null, "radio1="+radio1.isSelected()+", radio2="+radio2.isSelected()+", checkbox="+checkbox.isSelected()+", togglebutton="+toggleButton.isSelected());
            }
        };
